...
public class GameLoopThread extends Thread
{
    ...
    private final EnnemiView view; // l'objet SurfaceView que nous verrons plus bas
    ...
    public GameLoopThread(EnnemiView view) {
        this.view = view;
    }
    ...
    public void run()
    {
        ...
        while (running)
        {
            ...
            try {
                ...
                synchronized (view.getHolder()) {view.doDraw(c);Log.i("Test", "je me redessine");}
            }
            finally
            {
